export const updateSettingsPage = () => {
    let settingsCoverData = document.querySelector('.settings_cover_data');
    ...
    `;
    function getFileName(InputTarget) {
    ...
    function uplouadPics(Uplouadbt, Inputswich) {
        const coverBtEdit = document.querySelector(Uplouadbt);
        const inputUplouad = document.querySelector(Inputswich);
    ...
    function switchbtns(butn, inputTag) {
        const btns = document.querySelectorAll(butn);
        const inputs = document.querySelector(inputTag);
        const showPsStting = document.querySelector('.Sitting_show_btn');
        const eye = document.querySelector('.show_psStiing');
        const off = '<img class="Show" src="../public/logos/eye_off.svg">';
        btns.forEach((btn) => {
    ...
    function FaSittings() {
        const allSittingsData = document.getElementById('All_setings_FA_data');
